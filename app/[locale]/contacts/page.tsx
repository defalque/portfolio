      ...
      >
        ...
        <div className="flex flex-col justify-between gap-7 lg:flex-row lg:gap-6">
          <div
            role="group"
            aria-label={t("info")}
            className="text-base-color basis-1/2 space-y-3 text-sm/6.5 font-stretch-expanded sm:text-base/loose lg:space-y-5"
          >
            <p>{t("form-p")}</p>

            <div>
              <span>{t("location")}: </span>
              <span className="highlight font-medium">{t("place")}</span>
            </div>
            ...
            {/* <div>
              ...
              <Link
                ...
                className="focus-style highlight font-medium underline-offset-2 transition-discrete duration-300 hover:underline active:underline"
              >
                {t("phone-number")}
              </Link>
            </div> */}
            ...
            <div>
              <span>{t("speaks")}: </span>
              <span className="highlight font-medium">{t("languages")}</span>
            </div>
