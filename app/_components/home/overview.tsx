...
function Overview() {
  ...
  return (
    ...
    >
      ...
      <div className="-mx-(--spacing-x) flex flex-col items-start gap-5 overflow-hidden sm:-mx-(--sm-spacing-x) md:mx-(--md-spacing-x) md:flex-row md:items-center md:gap-10">
        <ul
          aria-label={t("aria-social")}
          className="flex items-center gap-3 px-(--spacing-x) sm:px-(--sm-spacing-x) md:px-(--md-spacing-x)"
        >
          <li>
            <Link
          ...
          <li>
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group block w-fit rounded-md border p-3 transition-discrete duration-300 hover:bg-gray-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-600 dark:hover:bg-zinc-900 dark:focus-visible:ring-orange-400"
              aria-label={t("gmail")}
            >
              <svg
                aria-hidden
        ...
        <LogoLoop ariaLabel={t("aria-skills")} />
      </div>
    </section>
  );
}
